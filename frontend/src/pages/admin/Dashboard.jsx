  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
        <div className="card border-indigo-500/30 bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/40 dark:to-slate-900/80 shadow-lg shadow-indigo-500/5">
          <p className="text-xs font-bold uppercase tracking-wider text-indigo-700 dark:text-indigo-300 mb-1">Total System Tasks</p>
          <p className="text-4xl font-extrabold tracking-tight font-mono drop-shadow-sm" style={{ color: 'var(--text-heading)' }}>{stats?.totalTasks || 0}</p>
          <p className="text-[11px] mt-2" style={{ color: 'var(--text-faint)' }}>Active &amp; completed work items</p>
        </div>

        <div className="card border-emerald-500/30 bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/40 dark:to-slate-900/80 shadow-lg shadow-emerald-500/5">
          <p className="text-xs font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-300 mb-1">Completed (7 Days)</p>
          <p className="text-4xl font-extrabold text-emerald-700 dark:text-emerald-300 tracking-tight font-mono drop-shadow-sm">{stats?.tasksCompletedThisWeek || 0}</p>
          <p className="text-[11px] mt-2" style={{ color: 'var(--text-faint)' }}>Closed out successfully</p>
        </div>

        <div className="card border-cyan-500/30 bg-gradient-to-br from-cyan-50 to-white dark:from-cyan-950/40 dark:to-slate-900/80 shadow-lg shadow-cyan-500/5">
          <p className="text-xs font-bold uppercase tracking-wider text-cyan-700 dark:text-cyan-300 mb-1">Total Hours Logged</p>
          <p className="text-4xl font-extrabold text-cyan-700 dark:text-cyan-300 tracking-tight font-mono drop-shadow-sm">{stats?.totalHours || 0}<span className="text-xl">h</span></p>
          <p className="text-[11px] mt-2" style={{ color: 'var(--text-faint)' }}>Across all team logs</p>
        </div>

        <div className="card border-purple-500/30 bg-gradient-to-br from-purple-50 to-white dark:from-purple-950/40 dark:to-slate-900/80 shadow-lg shadow-purple-500/5">
          <p className="text-xs font-bold uppercase tracking-wider text-purple-700 dark:text-purple-300 mb-1">Active Team Members</p>
          <p className="text-4xl font-extrabold text-purple-700 dark:text-purple-300 tracking-tight font-mono drop-shadow-sm">{stats?.activeEmployees || 0}</p>
          <p className="text-[11px] mt-2" style={{ color: 'var(--text-faint)' }}>Registered employees</p>
        </div>

        <div className="card border-fuchsia-500/30 bg-gradient-to-br from-fuchsia-50 to-white dark:from-fuchsia-950/40 dark:to-slate-900/80 shadow-lg shadow-fuchsia-500/5">
          <p className="text-xs font-bold uppercase tracking-wider text-fuchsia-700 dark:text-fuchsia-300 mb-1">Quizzes Generated</p>
          <p className="text-4xl font-extrabold text-fuchsia-700 dark:text-fuchsia-300 tracking-tight font-mono drop-shadow-sm">{stats?.totalQuizzesGenerated || 0}</p>
